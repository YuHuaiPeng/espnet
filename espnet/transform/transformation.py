...
import_alias = dict(
    ...
    time_stretch="espnet.transform.modified_spec_augment:TimeStretch",
    utt_stretch="espnet.transform.modified_spec_augment:UttStretch",
    utt_seg_stretch="espnet.transform.modified_spec_augment:UttSegStretch",
